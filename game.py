...
def checkCollision():
    if (paddle_1.xcor() + 20 >= ball.xcor() >= paddle_1.xcor() - 20) and (paddle_1.ycor() + 20 >= ball.ycor() >= paddle_1.ycor() - 60):
        ball.dx = ball.dx * -1
        ball.dy = ball.dy * -1
    ...
    if (paddle_2.xcor() + 20 >= ball.xcor() >= paddle_2.xcor() - 20) and (paddle_2.ycor() + 20 >= ball.ycor() >= paddle_2.ycor() - 60):
        ball.dx = ball.dx * -1
        ball.dy = ball.dy * -1
